...
const FixedContactButton = () => {
    ...
    return (
        <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 md:bottom-8 md:right-8 lg:bottom-12 lg:right-12 z-50 ">
            <AnimatePresence>
                {!showDropdown ? (
                    <motion.div
                    ...
                    <div className="relative">
                        ...
                        >
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs sm:text-sm">
                                            Hi! Klik salah satu dari kami untuk
                                            berbicara di{" "}
                            ...
                            <div className="px-3 sm:px-4">
                                <p className="text-xs sm:text-sm text-right text-gray-400 font-medium mt-2 sm:mt-3">
                                    Kami akan segera memberikan tanggapan
                                </p>
                                <p className="text-xs sm:text-sm text-right text-gray-400 font-medium mt-1 sm:mt-2">
                                    Please accept our Privacy Policy first to
                            ...
                            <div className="p-3 sm:p-4">
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs sm:text-sm text-green-700 bg-green-200 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-md mt-1 sm:mt-2">
                        ...
                        <motion.button
                            className="absolute -bottom-2 right-0 bg-[#39cd46] text-white w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center rounded-full shadow-lg hover:bg-[#36b640] transition-all"
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
