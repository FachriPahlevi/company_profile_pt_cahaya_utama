...
export default function Navbar() {
    ...
    const navLinks = [
        ...
        { href: "/about", text: "Tentang Kami" },
        {
            text: "Jasa",
            dropdownItems: [
                { href: "/son-security", text: "Son Security" },
        ...
        {
            href: "https://rekrutmen-cahayautama.com",
            text: "Rekrutmen",
            external: true,
        },
    ];
                            ...
                            <div key={link.text} className="relative">
                                {link.dropdownItems ? (
                                    ...
                                    <a
                                        ...
                                        className="text-sm lg:text-base font-medium text-gray-700 hover:text-primary-600"
                                    >
                                        {link.text}
                                    </a>
                                ) : (
