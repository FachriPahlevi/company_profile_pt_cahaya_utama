                    ...
                    <div className="gap-8 space-y-8">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-300">Dalam beberapa hal kami telah menerapkan teknologi yang dikembangkan terus-menerus sebagai perangkat kerja nyata</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="gap-8 space-y-8">
                        <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-300">Penempatan pengawas/kordinator disetiap group untuk melakukan fungsi kontrol, pengawasan dan koordinasi</p>
                                </div>
                            </div>
